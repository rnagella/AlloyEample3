...
//@interface AlloyExample2Object : NSObject
//@end

@interface AlloyExample2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AlloyExample2Object class]])
		{
			for (NSString *key in [[(AlloyExample2Object*)o modules] allKeys])
			{
