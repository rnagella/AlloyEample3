...
@interface AlloyExample2Object : KrollCoverageObject {
#else
@interface AlloyExample2Object : KrollObject {
#endif
@private
...
extern NSString * AlloyExample2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AlloyExample2Object *_alloyexample2;
    KrollObject* console;
	BOOL shutdown;
