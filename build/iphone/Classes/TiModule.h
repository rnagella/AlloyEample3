...
/**
 The base class for all AlloyExample2 modules
 */
...
/**
 AlloyExample2 Platform calls this method on startup.
 */
-(void)startup;

/**
 AlloyExample2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AlloyExample2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AlloyExample2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AlloyExample2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
