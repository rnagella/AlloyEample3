...
//Rare exceptions to indicate a bug in the _alloyexample2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AlloyExample2 proxies.
 */
