...
// in simulator we redefine to format for AlloyExample2 Developer console
...
{\
	NSString * exceptionName = [@"org.alloyexample2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.alloyexample2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAlloyExample2NativeItemNone = -1, 
	UIAlloyExample2NativeItemSpinner = -2,
	UIAlloyExample2NativeItemProgressBar = -3,
	
	UIAlloyExample2NativeItemSlider = -4,
	UIAlloyExample2NativeItemSwitch = -5,
	UIAlloyExample2NativeItemMultiButton = -6,
	UIAlloyExample2NativeItemSegmented = -7,
	
	UIAlloyExample2NativeItemTextView = -8,
	UIAlloyExample2NativeItemTextField = -9,
	UIAlloyExample2NativeItemSearchBar = -10,
	
	UIAlloyExample2NativeItemPicker = -11,
	UIAlloyExample2NativeItemDatePicker = -12,
	
	UIAlloyExample2NativeItemInfoLight = -13,
	UIAlloyExample2NativeItemInfoDark = -14,
	
	UIAlloyExample2NativeItemDisclosure = -15,
	
	UIAlloyExample2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AlloyExample2 instances of
