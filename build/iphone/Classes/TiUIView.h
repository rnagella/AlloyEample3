...
/**
 Base class for all AlloyExample2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AlloyExample2 view hierarchy (such as wrapped iOS UIViews) was touched.
